...
environment yet a mirror of production. This gave us several benefits. Playwright just becomes another end user (what we 
...
* Mocking in E2E tests can be difficult with a BFF architecture.
* Real services are probably better anyway, albeit slower.
* Seeding is essential for repeatability.

It's not perfect but our E2E tests are reliable and that's a tradeoff we can live with.
