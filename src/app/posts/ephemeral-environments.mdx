...
As a reminder, we made the trade-off to dockerise the end-to-end (E2E) testing infrastructure so the
environment behaves like a mirror of production, allowing E2E tests to run as if they were a real user.
There were issues with our approach; it was a trade-off after all.
